...
class AidTest {
    ...
    void testCountAmountsOfAid() {
        ...
        assertEquals(expected, aid.countAmountsOfAid(Paths.get("src/test/resources/exceptionmulticatch/population1.txt")));
    }
    ...
    void testCountAmountsOfAidWithNotExistingFilename() {
        Exception ex = assertThrows(IllegalStateException.class,
                () -> aid.countAmountsOfAid(Paths.get("src/test/resources/exceptionmulticatch/xyz.txt")));
        assertEquals("Something went wrong while counting.", ex.getMessage());
    ...
    void testCountAmountsOfAidWithInvalidLine() {
        Exception ex = assertThrows(IllegalStateException.class,
                () -> aid.countAmountsOfAid(Paths.get("src/test/resources/exceptionmulticatch/population2.txt")));
        assertEquals("Something went wrong while counting.", ex.getMessage());
    ...
    void testCountAmountsOfAidWithInvalidNumber() {
        Exception ex = assertThrows(IllegalStateException.class,
                () -> aid.countAmountsOfAid(Paths.get("src/test/resources/exceptionmulticatch/population3.txt")));
        assertEquals("Something went wrong while counting.", ex.getMessage());
    ...
    void testCountAmountsOfAidWithZeroNumber() {
        Exception ex = assertThrows(IllegalStateException.class,
                () -> aid.countAmountsOfAid(Paths.get("src/test/resources/exceptionmulticatch/population4.txt")));
        assertEquals("Something went wrong while counting.", ex.getMessage());
