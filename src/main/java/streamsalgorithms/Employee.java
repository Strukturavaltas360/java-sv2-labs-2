...
public class Employee {
    public static void main(String[] args) {
        List<Employee> employees = List.of(
                new Employee("employe1", 1970),
                new Employee("employe2", 2000),
                new Employee("employe3", 1955),
                new Employee("employe4", 1998),
                new Employee("employe5", 2001),
                new Employee("employe6", 1965)
        );
